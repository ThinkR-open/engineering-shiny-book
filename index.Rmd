...
I used the **knitr**\index{knitr} package [@R-knitr] and the **bookdown**\index{bookdown} package [@R-bookdown] to compile my book. My R session information is shown below:
