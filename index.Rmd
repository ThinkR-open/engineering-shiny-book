...
], and serving trillions of GB of data: even software that is used by one person who relies on this application to do their job is a production software. 
...
This part ends with a gentle introduction to CSS
