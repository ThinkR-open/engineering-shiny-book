...
^[You can now work with JavaScript in a server with Node.JS, but this won't be a useful software when working with `{shiny}`. See linked resources to learn more.]
.
