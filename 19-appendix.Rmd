...
```{r echo=FALSE, fig.cap="(ref:conceptmapminifyr)", out.width="100%"}
...
withr::with_seed(
  608, {
    nms <- charlatan::ch_name(2)
    company <- charlatan::ch_company(2)
  }
)
nms
company
...
```{r echo=FALSE, fig.cap="(ref:excalidraw)", out.width="100%"}
