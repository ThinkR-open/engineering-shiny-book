...
\@ref(fig:19-appendix-1) is the concept map for this application, using Xmind.
...
Let's start by drawing a small mockup of our front-end using [Excalidraw](https://excalidraw.com/).
