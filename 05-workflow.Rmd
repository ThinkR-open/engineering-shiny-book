...
This "UI first" approach will be made possible for Shiny with notably one package, `{shinipsum}` [@R-shinipsum], and tools like basic CSS, and some `{golem}` functions.
