...
In this section, we will give an overview of the different steps of this workflow: the rest of the book will cover each of these steps in more depth.
...
For this point, you can use what we call a "Rmd-first" approach, by combining R functions with the writing of Vignettes that describes the internals of the application. 
