...
(ref:scanningcap) How we design a webpage and how a user will really scan it. From [Don't make me think - Steve Krug](http://sensible.com/dmmt.html).


```{r, echo=FALSE, fig.cap="(ref:scanningcap)", out.width="95%"}
...
(ref:hexmakecap) Snapshot of the Shiny application [`{hexmake}`](https://connect.thinkr.fr/hexmake/).

```{r, echo=FALSE, fig.cap="(ref:hexmakecap)", out.width="95%"}
...
(ref:tidytuesdaybutton1cap) Snapshot of a former version of {tidytuesday201942} Shiny application with buttons not visible as buttons.

```{r, echo=FALSE, fig.cap="(ref:tidytuesdaybutton1cap)"}
knitr::include_graphics("img/tidytuesdaybutton1.png")
```

To the one with a little bit of CSS (which is the one online):

(ref:tidytuesdaybutton2cap) Snapshot of a version of {tidytuesday201942} Shiny application with buttons visually identified as buttons.

```{r, echo=FALSE, fig.cap="(ref:tidytuesdaybutton2cap)"}
...
```{r, echo=FALSE, fig.cap="(ref:uxtidytuesdayappcap)"}
...
(ref:plotlycap) Output of {plotly} with all its buttons available.

```{r, echo=FALSE, fig.cap="(ref:plotlycap)"}
...
```{r 06-ux-matters-16, fig.cap="(ref:jetcolorstritan)"}
...
(ref:accessibilitycap) Evaluation of web accessibility of {hexmake} application.

```{r, echo=FALSE, fig.cap="(ref:accessibilitycap)"}
