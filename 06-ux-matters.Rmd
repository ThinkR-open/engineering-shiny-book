...
> 'The Art of UNIX Programming - Basic of the Unix Philosophy', [@ericraymond2003]
...
> "The cranky user: The Principle of Least Astonishment" <https://www.ibm.com/developerworks/web/library/us-cranky10/us-cranky10-pdf.pdf">
...
It is also possible to build your own with a little bit of HTML, CSS and JavaScript, as shown on [the `notifyjsexample` repository](https://github.com/ColinFay/notifyjsexample).
...
It's pretty tempting to think of this as a single entity and throw the whole code base into one big project and hope for the best.
...
Or, as simply put in *The Art of Unix Programming* [@ericraymond2003]:
...
The simplest solution iss a button so that the user signals to the application that now they are ready for the application to compute what they have parameterized.
