...
In step of the workflow, you will be linking the back-end and front-end together, and working on the global engineering of the application, _i.e_:
...
```{r 11-step-by-step-build-2-bis, eval = FALSE}
...
```{r 11-step-by-step-build-3-bis, eval = FALSE}
...
### Code Coverage & Continous Integration
...
```{r 11-step-by-step-build-4-bis, eval = FALSE}
...
```{r 11-step-by-step-build-5-bis, eval = FALSE}
...
Good news!
You can make any function being "dev-dependant" with the `make_dev()` function: 
