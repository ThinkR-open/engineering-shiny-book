...
While doing that, you can not built this large application by writting all the codebase into one, maybe two files, that is simply impossible to maintain on the long run, nor to use on a daily basis while developing. 
So, what to do? 
