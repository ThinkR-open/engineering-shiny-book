...
Building a robust, maintainable and shareable Shiny application will be made possible by building an R package.
...
Frameworks for package testing are robust and widely documented in the R world, and if you choose to embrace the "Shiny App as a Package" strucutre, you do not have to put any extra-effort for testing your application back-end: use a canonical testing framework like `{testthat}` [@R-testthat]. 
