...
> `r right_link("Modularizing Shiny app code - shiny.rstudio.com", "https://shiny.rstudio.com/articles/modules.html")`
...
Understanding all of this is not the purpose of this chapter: just remember that `{shiny}` input and output ids **have** to be unique, just as any id on a webpage, so that the browser knows where to put what it receives from R, and R knows what to listen to from the browser.
...
As you can see, the **app\_ui** contains a series of calls to thz
