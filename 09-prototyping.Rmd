...
If we run this code two times, we should get different results, as seen on Figure \@ref(fig:09-prototyping-4) and Figure \@ref(fig:09-prototyping-5).[^prototyping-1]
