...
```{r 10-prototyping-1-bis, echo=FALSE, fig.cap="(ref:mvp)", out.width="100%"}
...
```{r 10-prototyping-3, fig.cap="(ref:randomplot1)", out.width="100%"}
random_ggplot() + 
...
```{r 10-prototyping-4, fig.cap="(ref:randomplot2)", out.width="100%"}
random_ggplot() + 
  labs(title = "Random plot") 
```
...
```{r 10-prototyping-2-bis, echo=FALSE, fig.cap="(ref:shinipsum)", out.width="100%"}
