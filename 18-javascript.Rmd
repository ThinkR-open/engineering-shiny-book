...
^[See this post on dev.to <https://dev.to/buzzingbuzzer/comment/g0g> for a quick introduction to the general concept of web socket]
...
If your application does API calls, chances are that right now you have being doing them straight from R. 
...
As JavaScript is run inside the users' browser, the limitation will apply to the users' IPs, not the one where the application is deployed, allowing you to scale more easily your application. 
