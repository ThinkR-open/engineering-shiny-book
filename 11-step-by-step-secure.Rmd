...
Shiny is computing
✓ Shiny is still running
-- Setting id main_ui_1-left_ui_1-pkg_name_ui_1-package with value d --
Shiny is computing
✓ Shiny is still running
-- Setting id main_ui_1-left_ui_1-pkg_name_ui_1-package with value e --
Shiny is computing
✓ Shiny is still running
```
...
```{r 11-step-by-step-secure-1-bis, include = FALSE}
test <- crrry::CrrryOnPage$new(
  chrome_bin = pagedown::find_chrome(),
  chrome_port = httpuv::randomPort(),
...
```{r 11-step-by-step-secure-35, eval = TRUE}
...
```{r 11-step-by-step-secure-2-bis, eval = TRUE, include=FALSE}
...
```{r 11-step-by-step-secure-3-bis, eval = FALSE}
# We are creating a first data.frame that records the launch 
# of the container.
results <- dockerstats::dockerstats("xmk2", extra = "launch")
...
Shiny is computing
✓ Shiny is still running
-- Setting id main_ui_1-left_ui_1-pkg_name_ui_1-package with value f --
Shiny is computing
✓ Shiny is still running
-- Setting id main_ui_1-left_ui_1-pkg_name_ui_1-package with value g --
Shiny is computing
✓ Shiny is still running
-- Setting id main_ui_1-left_ui_1-pkg_name_ui_1-package with value h --
Shiny is computing
✓ Shiny is still running
-- Setting id main_ui_1-left_ui_1-pkg_name_ui_1-package with value i --
Shiny is computing
✓ Shiny is still running
-- Setting id main_ui_1-left_ui_1-pkg_name_ui_1-package with value j --
Shiny is computing
✓ Shiny is still running
```

```{r 11-step-by-step-secure-4-bis, eval = TRUE, cache=TRUE}
# Stopping the docker container
system("docker kill xmk2")
