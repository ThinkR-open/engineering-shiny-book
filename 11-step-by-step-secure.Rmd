...
```{r gremlins, echo=FALSE, fig.cap="(ref:gremlinscap)", out.width='100%'}
...
```{r shinytestcap, echo=FALSE, fig.cap="(ref:shinytestcap)", out.width='100%'}
...
```{r shinyloadtestreport, echo=FALSE, fig.cap="(ref:shinyloadtestreport)", out.width="100%"}
...
```{r dockerstatscap, echo=FALSE, fig.cap='(ref:dockerstatscap)', out.width='100%'}
...
```{r geojsoncap, echo=FALSE, fig.cap='(ref:geojsoncap)', out.width='100%'}
