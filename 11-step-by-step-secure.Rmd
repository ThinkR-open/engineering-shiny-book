...
Using this button, you can take various recording of your shiny application at different states, as shown in figure \@ref(fig:11-step-by-step-secure-10).
...
This function will generate an HTML report of all the things computed by `{shinyloadtest}`, as show in figure \@ref(fig:11-step-by-step-secure-23).
...
Figure \@ref(fig:11-step-by-step-secure-31) is what both these processes look side to side.
