...
+ [ ] The contact and debugging processes are clear and everybody involved in the project management knows what to expect
...
The second one is meant for [ShinyProxy](https://www.shinyproxy.io/), an open source solution for deploying containerized Shiny applications, and the third for [Heroku](https://www.heroku.com/), an online service that can serve containerized applications (not specific to Shiny). 
