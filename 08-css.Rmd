...
CSS is what handles the design, i.e. the visual rendering of the web page: the color of the header, the font, the background, and everything that makes a web page looks like it is not from 1983 (again, we are simplifying for the sake of clarity). 
...
Now you have got a grasp on how to getting started writing your own CSS, how do you integrate it inside your Shiny Application? 
...
If you want to use external CSS template, there are several packages that exist that can do implement new custom UI designs for your application. 
Here are some: 

+ [`{resume}`](https://github.com/ColinFay/resume), provides an implementation of the [Bootstrap Resume Template](https://github.com/BlackrockDigital/startbootstrap-resume).

+ [`{nessy}`](https://github.com/ColinFay/nessy), a port of [NES CSS](https://github.com/nostalgic-css/NES.css).

+ [`{skeleton}`](https://github.com/ColinFay/skeleton), [Skeleton CSS](http://getskeleton.com/).
