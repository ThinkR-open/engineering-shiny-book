...
> "Rome ne fut pas faite toute en un jour". French proverb
...
> The KISS principle states that most systems work best if they are kept simple rather than made complicated; therefore, simplicity should be a key goal in design, and unnecessary complexity should be avoided. `r right_link("KISS principle, Wikipedia article", "https://en.wikipedia.org/wiki/KISS_principle")`
...
When choosing how and what to implement, try to make a rule to go for the simplest solution
...
#### A. Version Control & Test all the things {-}
